        ...
        try (FileInputStream fis = new FileInputStream(inputFilePath);
            ...
            for (Row row : sheet) {
                if (rowNum == 0) {
                    ...
                    String srcnodeConversionRate = DataValidatorUtils.getCellValueAsString(row.getCell(columnMap.get("srcnode_conversion_rate")));
                    String cnvRcnAcqDePos = DataValidatorUtils.getCellValueAsString(row.getCell(columnMap.get("CNV_RCN_ACQ_DE_POS")));
                    String cnvRcnAcqRate = DataValidatorUtils.getCellValueAsString(row.getCell(columnMap.get("CNV_RCN_ACQ_RATE")));
                    ...
                    String dateCnvAcq = DataValidatorUtils.getCellValueAsString(row.getCell(columnMap.get(DNColumns.DATE_CNV_ACQ.getColumnName())));
                    String srcNodeDateConversion = DataValidatorUtils.getCellValueAsString(row.getCell(columnMap.get(RTDataColumns.SRCNODE_DATE_CONVERSION.getColumnName())));
...
//                    String MTI = DataValidatorUtils.getCellValueAsString(row.getCell(columnMap.get(DNColumns.MTI.getColumnName())));
                    ...
                    String oAmtReconIss = DataValidatorUtils.getCellValueAsString(row.getCell(columnMap.get("O_AMT_RECON_ISS")));
                    String snknodeAmountRequested = DataValidatorUtils.getCellValueAsString(row.getCell(columnMap.get("snknode_amount_requested")));
