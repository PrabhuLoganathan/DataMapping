...
public class DataMapperUtils {
    ...
    public static void createHeaderRow(Sheet outputSheet) {
        ...
        headerRow.createCell(4).setCellValue(RTDataColumns.TRAN_NR.getColumnName());
        headerRow.createCell(5).setCellValue("SUBSTR(R.TRAN_DESC,13)");
        headerRow.createCell(6).setCellValue("DRAFT_CAPTURE_FLG_DN");
        headerRow.createCell(7).setCellValue(RTDataColumns.DRAFT_CAPTURE.getColumnName());
        headerRow.createCell(8).setCellValue(RTDataColumns.STAN_IN.getColumnName());
        headerRow.createCell(9).setCellValue("STANDIN_ACT");
        headerRow.createCell(10).setCellValue("DATE_RECON_ACQ");
        headerRow.createCell(11).setCellValue(RTDataColumns.SRCNODE_DATE_SETTLE.getColumnName());
        headerRow.createCell(12).setCellValue("ADL_RQST_AMT1");
        headerRow.createCell(13).setCellValue(RTDataColumns.SRCNODE_CASH_REQUESTED.getColumnName());
        headerRow.createCell(14).setCellValue("CUR_RECON_ACQ_1");
        headerRow.createCell(15).setCellValue(RTDataColumns.SRCNODE_CURRENCY_CODE.getColumnName());

        headerRow.createCell(16).setCellValue("CNV_RCN_ACQ_RATE");
        headerRow.createCell(17).setCellValue(RTDataColumns.SRCNODE_CONVERSION_RATE.getColumnName());
        headerRow.createCell(18).setCellValue("CNV_RCN_ACQ_DE_POS");
        headerRow.createCell(19).setCellValue(RTDataColumns.SRCNODE_CONVERSION_RATE.getColumnName());

        headerRow.createCell(20).setCellValue("DATE_CNV_ACQ");
        headerRow.createCell(21).setCellValue(RTDataColumns.SRCNODE_DATE_CONVERSION.getColumnName());

        headerRow.createCell(22).setCellValue("ODE_MTI");
        headerRow.createCell(23).setCellValue(RTDataColumns.SRCNODE_ORIGINAL_DATA.getColumnName());

        headerRow.createCell(24).setCellValue("ODE_SYS_TRA_AUD_NO");
        headerRow.createCell(25).setCellValue(RTDataColumns.SRCNODE_ORIGINAL_DATA.getColumnName());

        headerRow.createCell(26).setCellValue("ODE_TSTAMP_LOCL_TR");
        headerRow.createCell(27).setCellValue(RTDataColumns.SRCNODE_ORIGINAL_DATA.getColumnName());

        headerRow.createCell(30).setCellValue(RTDataColumns.SNKNODE_REQ_SYS_TRACE.getColumnName());
        headerRow.createCell(31).setCellValue("SYS_TRACE_AUDIT_NO");

        headerRow.createCell(32).setCellValue(RTDataColumns.SNKNODE_REV_SYS_TRACE.getColumnName());
        headerRow.createCell(33).setCellValue("SYS_TRACE_AUDIT_NO");

        headerRow.createCell(35).setCellValue(RTDataColumns.SRCNODE_ADDITIONAL_DATA.getColumnName());
        headerRow.createCell(36).setCellValue("SYS_TRACE_AUDIT_NO");

        headerRow.createCell(37).setCellValue(RTDataColumns.SNKNODE_DATE_SETTLE.getColumnName());
        headerRow.createCell(38).setCellValue("DATE_RECON_ISS");

        headerRow.createCell(39).setCellValue("DATE_RECON_NET");

        headerRow.createCell(40).setCellValue(RTDataColumns.SNKNODE_AMOUNT_REQUESTED.getColumnName());
       ...
       // headerRow.createCell(47).setCellValue(RTDataColumns.SNKNODE_CASH_REQUESTED.getColumnName());
        headerRow.createCell(48).setCellValue("ADL_RESP_AMT1");

        headerRow.createCell(49).setCellValue(RTDataColumns.SNKNODE_CURRENCY_CODE.getColumnName());
        ...
        headerRow.createCell(53).setCellValue(RTDataColumns.SNKNODE_CONVERSION_RATE.getColumnName());
        headerRow.createCell(54).setCellValue("CNV_RCN_ISS_DE_POS");
        headerRow.createCell(55).setCellValue("CNV_RCN_ISS_RATE");

        headerRow.createCell(56).setCellValue(RTDataColumns.SNKNODE_DATE_CONVERSION.getColumnName());
        ...
        headerRow.createCell(61).setCellValue(RTDataColumns.TRAN_TYPE.getColumnName());
        headerRow.createCell(62).setCellValue("TRAN_TYPE_ID");

        headerRow.createCell(63).setCellValue(RTDataColumns.FROM_ACCOUNT.getColumnName());
        headerRow.createCell(64).setCellValue("TRAN_TYPE_ID");

        headerRow.createCell(65).setCellValue(RTDataColumns.TO_ACCOUNT.getColumnName());
        headerRow.createCell(66).setCellValue("TRAN_TYPE_ID");

        headerRow.createCell(67).setCellValue(RTDataColumns.AMOUNT_TRAN_REQUESTED.getColumnName());
        headerRow.createCell(68).setCellValue("AMT_TRAN");
        headerRow.createCell(69).setCellValue("O_AMT_TRAN");

        headerRow.createCell(70).setCellValue(RTDataColumns.AMOUNT_CASH_REQUESTED.getColumnName());
        headerRow.createCell(71).setCellValue("ADL_RQST_AMT0");

        headerRow.createCell(72).setCellValue(RTDataColumns.GMT_DATE_TIME.getColumnName());
        headerRow.createCell(73).setCellValue("GMT_TIME");

        headerRow.createCell(74).setCellValue(RTDataColumns.TIME_LOCAL.getColumnName());
        headerRow.createCell(75).setCellValue("TSTAMP_LOCAL");

        headerRow.createCell(76).setCellValue(RTDataColumns.PAN.getColumnName());
        headerRow.createCell(77).setCellValue("TSTAMP_LOCAL");

        headerRow.createCell(78).setCellValue(RTDataColumns.EXPIRY_DATE.getColumnName());
        headerRow.createCell(79).setCellValue("DATE_EXP");

        headerRow.createCell(80).setCellValue(RTDataColumns.MSG_CLASS.getColumnName());
    ...
    private static void mapRowData(Row outputRow, Row dnDataRow, Row rtDataRow, Map<String, Integer> rtColumnMap, Map<String, Integer> dnColumnMap) {
        ...
        outputRow.createCell(5).setCellValue(getCellValueAsString(dnDataRow.getCell(dnColumnMap.get("TRAN_DESC")))); // TRAN_DESC from DN_Data
        ...
        outputRow.createCell(19).setCellValue(getCellValueAsString(dnDataRow.getCell(dnColumnMap.get("DATE_CNV_ACQ")))); // DATE_CNV_ACQ from DN_Data
        ...
        outputRow.createCell(26).setCellValue(getCellValueAsString(dnDataRow.getCell(dnColumnMap.get("DATE_RECON_ISS")))); // DATE_RECON_ISS from DN_Data
        outputRow.createCell(27).setCellValue(getCellValueAsString(dnDataRow.getCell(dnColumnMap.get("DATE_RECON_NET")))); // DATE_RECON_NET from DN_Data
        ...
        outputRow.createCell(31).setCellValue(getCellValueAsString(dnDataRow.getCell(dnColumnMap.get("CUR_RECON_ISS")))); // CUR_RECON_ISS from DN_Data
        //outputRow.createCell(32).setCellValue(getCellValueAsString(rtDataRow.getCell(rtColumnMap.get(RTDataColumns.SNKNODE_CASH_REQUESTED.getColumnName())))); // snknode_cash_requested from Realtime_Data
        ...
        outputRow.createCell(34).setCellValue(getCellValueAsString(dnDataRow.getCell(dnColumnMap.get("CUR_RECON_NET")))); // CUR_RECON_NET from DN_Data
        outputRow.createCell(35).setCellValue(getCellValueAsString(dnDataRow.getCell(dnColumnMap.get("CUR_CARD_BILL")))); // CUR_CARD_BILL from DN_Data
        outputRow.createCell(36).setCellValue(getCellValueAsString(dnDataRow.getCell(dnColumnMap.get("CNV_RCN_ISS_RATE")))); // CNV_RCN_ISS_RATE from DN_Data
        outputRow.createCell(37).setCellValue(getCellValueAsString(dnDataRow.getCell(dnColumnMap.get("DATE_CNV_ISS")))); // DATE_CNV_ISS from DN_Data
        outputRow.createCell(38).setCellValue(getCellValueAsString(dnDataRow.getCell(dnColumnMap.get("INST_ID_RECON_ISS")))); // INST_ID_RECON_ISS from DN_Data
